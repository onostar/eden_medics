<?php
    ...
    ?>
    <div class="results">
        <a href="javascript:void(0)"  onclick="showPage('edit_price_form.php?item=<?php echo $row->item_id?>')"><?php echo $row->item_name." (Price => ₦".$row->sales_price.", Quantity => ".$quantity.")"?></a>
    </div>
