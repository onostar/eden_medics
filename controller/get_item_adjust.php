<?php
    ...
    ?>
    <div class="results">
        <a href="javascript:void(0)"  onclick="showPage('view_batch.php?item=<?php echo $row->item_id?>')" title="view batches"><?php echo $row->item_name." (Price => ₦".$row->sales_price.", Quantity => ".$quantity.")"?></a>
    </div>
