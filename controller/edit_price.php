<?php
    ...
    // $store_name = $strs->store;
        ...
        $change_price->update_six('items', 'cost_price', $cost_price, 'sales_price', $sales_price, 'pack_price', $pack_price, 'pack_size', $pack_size, 'wholesale', $wholesale, 'wholesale_pack', $wholesale_pack, /* 'carton_role', $carton_price, 'carton_size', $carton_size, */ 'item_id', $item);
